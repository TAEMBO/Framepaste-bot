...
module.exports = {
  run: (client, interaction) => {
    ...
    interaction.reply("Restarting...").then(async ()=> {client.channels.cache.get(client.config.mainServer.channels.modlogs).send({content: `:exclamation:  Restart by **${interaction.user.tag}** :exclamation:`}); eval(process.exit(-1))})
  },
